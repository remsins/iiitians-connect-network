...
const Index = () => {
  ...
  const teamData = {
    design: [
      { name: "Arjun Sharma", role: "UI/UX Designer", institute: "IIIT Gwalior" },
      { name: "Priya Patel", role: "Graphic Designer", institute: "IIIT Kota" },
    ],
    content: [
      { name: "Rahul Singh", role: "Content Writer", institute: "IIIT Allahabad" },
      { name: "Sneha Agarwal", role: "Social Media Manager", institute: "IIIT Vadodara" },
    ],
    social: [
      { name: "Karan Mehta", role: "Community Manager", institute: "IIIT Bangalore" },
      { name: "Ananya Roy", role: "Outreach Coordinator", institute: "IIIT Delhi" },
    ]
  };
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white rounded-2xl p-8 shadow-lg transform hover:scale-105 transition-all duration-300">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Aditya Sharma</h3>
                <p className="text-indigo-600 font-medium">President</p>
                <p className="text-gray-600">IIIT Guwahati</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg transform hover:scale-105 transition-all duration-300">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Nisha Kumar</h3>
          ...
          <div className="space-y-6">
            {[
              { name: "Design Lead", key: "design", lead: "Rohit Gupta", institute: "IIIT Gwalior" },
              { name: "Content Lead", key: "content", lead: "Meera Jain", institute: "IIIT Allahabad" },
              { name: "Social Lead", key: "social", lead: "Vikash Yadav", institute: "IIIT Bangalore" }
            ].map((team) => (
